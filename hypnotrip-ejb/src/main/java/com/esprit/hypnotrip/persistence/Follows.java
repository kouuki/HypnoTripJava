...
public class Follows implements java.io.Serializable {
	...
	private boolean wishStat;

	private User user;
	private Pages pages;

	private Integer nbrFollowers;
	private Integer nbrPost;
	...
	@Transient
	public Integer getNbrPost() {
		return nbrPost;
	}

	public void setNbrPost(Integer nbrPost) {
		this.nbrPost = nbrPost;
	}

	public boolean isWishStat() {
		return wishStat;
	}

	public void setWishStat(boolean wishStat) {
