...
@ManagedBean
@ViewScoped
public class DisplayAllTouristicPlacesForRate {
	@EJB
	private PageServiceLocal pageServiceLocal;
	@EJB
	private ToursiticPlaceServiceLocal toursiticPlaceServiceLocal;
	@EJB
	...
	public void init() {
		...
		myPages = toursiticPlaceServiceLocal.getAllTouristicPlaces();
	}
